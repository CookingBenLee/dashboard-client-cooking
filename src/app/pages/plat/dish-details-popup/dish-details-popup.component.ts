...
export class DishDetailsPopupComponent {
  ...
  ngOnInit(): void {
    ...
    this.getAll(this.plat.dishesId.id)
  ...
  calculPlat() {
    this.plat.dishesId.poids = 0
    this.plat.dishesId.cout = 0
    this.compositionDishes.forEach(cp => {
      this.plat.dishesId.poids += cp.quantity
      this.plat.dishesId.cout += cp.cout
